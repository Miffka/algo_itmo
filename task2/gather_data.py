...
if __name__ == "__main__":
    ...
    parser.add_argument("--output_1d", default=osp.join(system_config.data_dir, "task2_1d.csv"), help="Output file")
    parser.add_argument("--output_data_2d", default=osp.join(system_config.data_dir, "task2_data_2d.csv"), help="Output file")
    parser.add_argument("--output_2d", default=osp.join(system_config.data_dir, "task2_2d.csv"), help="Output file")
